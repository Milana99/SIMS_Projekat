...
{
    public class InstrucitonsForSpecialistExamination
    {
        ...
        public InstrucitonsForSpecialistExamination(int id, string Specialist, string refer, string patient,  string description)
        {
